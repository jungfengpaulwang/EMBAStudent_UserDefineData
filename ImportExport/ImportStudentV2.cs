...
namespace Student_UserDefinedData.ImportExport
{
    public partial class ImportStudentV2 : FISCA.Presentation.Controls.BaseForm, SmartSchool.API.PlugIn.Import.ImportWizard
    {
        ...
        private List<string> _StudentFields = new List<string>(new string[] { "學生系統編號", "學號", "班級", "姓名" });
        ...
        public ImportStudentV2(string title, Image img)
        {
            ...
            // 填入學生狀態選項
            cboStudStatus.Items.Add("在學");
            cboStudStatus.Items.Add("休學");
            cboStudStatus.Items.Add("退學");
            cboStudStatus.Items.Add("畢業");
            cboStudStatus.Items.Add("刪除");
            cboStudStatus.Text = "在學";
        ...
        private void wizardPage3_AfterPageDisplayed(object sender, WizardPageChangeEventArgs e)
        {
            ...
            switch (cboStudStatus.Text)
            {
                ...
                case "休學":
                    ...
                    break;
                case "退學":
                    _StudStatus = K12.Data.StudentRecord.StudentStatus.退學;
                    break;
                case "畢業":
