...
namespace Student_UserDefinedData
{
    ...
    public class LoadManager
    {
        ...
        private static void StartJHSchool()
        {
            ...
            // 設定自訂資料欄位樣版
            //K12.Presentation.NLDPanels.Student.AddDetailBulider<UserDefineDataItem>();
            ...
            RibbonBarButton rbSetUserDefineData = MotherForm.RibbonBarItems["學生", "其它"]["自訂資料欄位管理"];
            ...
            MenuButton rbUserDefDataExport = MotherForm.RibbonBarItems["學生", "資料統計"]["匯出"]["其它相關匯出"];
            ...
            MenuButton rbUserDefDataImport = MotherForm.RibbonBarItems["學生", "資料統計"]["匯入"]["其它相關匯入"];
