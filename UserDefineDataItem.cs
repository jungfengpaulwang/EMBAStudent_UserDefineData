...
{
    // 自訂資料欄位
    [FCode("JHSchool.Student.UserDefineData", "自訂資料欄位(Beta)")]
    public partial class UserDefineDataItem : DetailContent
    {
        ...
        {
            InitializeComponent();
            _DeleteDataList = new List<DAL.UserDefData>();
            _InsertDataList = new List<DAL.UserDefData>();
            _UserDefDataDict = new Dictionary<string, DAL.UserDefData>();
